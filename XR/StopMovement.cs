...
public class StopMovement : MonoBehaviour
{
    ...
    [Range(0, 0)] public float lookSensitivity;
    ...
    [Range(0, 0)] public float walkSpeed;



    // Speed of sideways (left and right) movement
    [Range(0, 0)] public float strafeSpeed;
    ...
    // is when sprinting
    [Range(0, 0)] public float sprintFactor;



    [Range(0, 0)] public float jumpHeight;
    public int maxJumps;
